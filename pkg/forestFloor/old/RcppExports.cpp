...
// recTree
void recTree(int vars, int obs, int ntree, bool calculate_node_pred, NumericMatrix X, NumericVector Y, IntegerMatrix leftDaughter, IntegerMatrix rightDaughter, IntegerMatrix nodestatus, NumericMatrix xbestsplit, NumericMatrix nodepred, IntegerMatrix bestvar, IntegerMatrix inbag, NumericMatrix localIncrements);
RcppExport SEXP forestFloor_recTree(SEXP varsSEXP, SEXP obsSEXP, SEXP ntreeSEXP, SEXP calculate_node_predSEXP, SEXP XSEXP, SEXP YSEXP, SEXP leftDaughterSEXP, SEXP rightDaughterSEXP, SEXP nodestatusSEXP, SEXP xbestsplitSEXP, SEXP nodepredSEXP, SEXP bestvarSEXP, SEXP inbagSEXP, SEXP localIncrementsSEXP) {
BEGIN_RCPP
    {
        ...
        recTree(vars, obs, ntree, calculate_node_pred, X, Y, leftDaughter, rightDaughter, nodestatus, xbestsplit, nodepred, bestvar, inbag, localIncrements);
    }
    return R_NilValue;
END_RCPP
}
